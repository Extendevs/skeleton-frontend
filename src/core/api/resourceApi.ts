...
export interface CrudApiConfig<TRecord, TForm, TParams> {
  basePath: string;
...
export const createCrudApi = <TRecord, TForm, TParams = Record<string, unknown>>({
  basePath,
  mapListResponse,
  mapCreateInput,
  mapUpdateInput
}: CrudApiConfig<TRecord, TForm, TParams>) => {
